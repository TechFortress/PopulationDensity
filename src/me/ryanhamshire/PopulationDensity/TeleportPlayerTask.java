...
class TeleportPlayerTask extends BukkitRunnable {
    ...
    public TeleportPlayerTask(Player player, Location destination, boolean makeFallDamageImmune, PopulationDensity plugin, boolean teleportNearbyAnimals, DropShipTeleporter dropShipTeleporter) {
        this.player = player;
    ...
    public TeleportPlayerTask(Player player, Location destination, boolean makeFallDamageImmune, PopulationDensity plugin, boolean teleportNearbyAnimals) {
        this(player, destination, makeFallDamageImmune, plugin, teleportNearbyAnimals, null);
    }
        ...
        ArrayList<Entity> entitiesToTeleport = new ArrayList<Entity>();
            ...
            for (Entity entity : nearbyEntities) {
                ...
                if (entity instanceof LivingEntity) {
                    ...
                    if ((creature.isLeashed() && player.equals(creature.getLeashHolder())) || (creature.getPassengers().contains(player) && creature.getPassengers().size() < 2)) {
